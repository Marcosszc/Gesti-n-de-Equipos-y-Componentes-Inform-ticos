  ...
  const fetchComponentes = async () => {
    ...
    try {
      if (isSupabaseConfigured) {
        ...
        // Cargar únicamente los datos reales de la base de datos de Supabase
        setItems(data && data.length > 0 ? data.map(mapFromDb) : []);
      } else {
                  ...
                  <tr>
                    <td colSpan={8} className="px-4 py-12 text-center text-slate-500">
                      ...
                      <p className="text-xs mt-1">
                        Utiliza el botón "Nuevo Componente" para agregar registros a la base de datos
                      </p>
                    </td>
                  </tr>
                ) : (
